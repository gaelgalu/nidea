...
public class CollaboratorController {
	...
	public Collaborator createCollaborator(@RequestBody CollaboratorRequest collaboratorRequest){
		...
		Collaborator collaborator = new Collaborator(increment.getIncrementId(collaborator_repository), collaboratorRequest.getName(), collaboratorRequest.getLastname(), collaboratorRequest.getEmail(),collaboratorRequest.getPassword(), new ArrayList<Idea>());
